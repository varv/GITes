...
MaxBuffSize = 8192 #maximum data size that can be retrieved at once (recommended values: 4096 (more stable) or 8192 (faster))
delay = 0.001 #delay (in s) between two batches of data (recommended values: 0.01 (more stable) or 0.001 (faster))
